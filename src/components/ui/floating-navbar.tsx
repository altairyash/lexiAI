      ...
      >
        {navItems.map((navItem, idx) => (
          <Link
            ...
            href={navItem.link}
            className={cn(
              "relative dark:text-neutral-50 items-center flex space-x-1 text-neutral-400 dark:hover:text-neutral-300 hover:text-neutral-500 transition-colors text-sm font-medium",
        ...
        <button 
          ...
          className="border text-sm font-medium relative border-white/20 dark:border-white/20 text-white dark:text-white px-4 py-2 rounded-full hover:bg-white/10 transition-colors"
        >
          <span>GitHub</span>
